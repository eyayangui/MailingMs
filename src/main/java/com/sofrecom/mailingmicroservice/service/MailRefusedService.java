...
@Service
public class MailRefusedService {
    @Autowired
    ...
    @KafkaListener(topics = "refusedMailNotification", groupId = "mailingServiceGroup")
    public void listen(String bookingJson) {
        try {
            ...
            sendEmail(passengerEmail, "Reservation is refused", emailContent);
        } catch (Exception e) {
